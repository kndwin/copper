...
import { type PlaceDetails, type Prisma } from "@prisma/client";
...
export const placesRouter = router({
  ...
  getPlaceDetails: publicProcedure
    ...
    .query(async ({ ctx, input }) => {
      ...
      const response: TPlaceDetails =
        placeDetailsResponse as unknown as TPlaceDetails;
...
const mockAutocompleteResult: PlaceAutocompleteResponse["data"] = {
  predictions: [
    {
      description:
...
const mockPlaceDetailResult: PlaceDetailsResponse["data"] = {
  html_attributions: [],
  result: {
    address_components: [
      {
