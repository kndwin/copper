...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/knd/Code/personal/copper/prisma/gen.ts",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "prisma/gen.ts/libquery_engine-darwin-arm64.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/gen.ts/schema.prisma")
